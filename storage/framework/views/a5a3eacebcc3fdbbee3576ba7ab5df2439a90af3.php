...
<?php $__env->startSection('scripts'); ?>
    <script type="text/javascript">
        layui.use(['element', 'form', 'table', 'layedit', 'laypage', 'layer'], function () {
            ...
            table.render({
                elem: '#demo'
                ,where: {id: "<?php echo e($cid); ?>"}
                , url: "<?php echo e(url('admin/analysis/jilu_list')); ?>" //数据接口
                , page: true //开启分页
            ...
            table.on('tool(test)', function (obj) {
                ...
                if (obj.event === 'delete') {
                    layer.confirm('真的删除行么', function (index) {
                        $.ajax({
                            url: '<?php echo e(url('admin/analysis/jilu_delete')); ?>',
                            type: 'post',
                            dataType: 'json',
                            data: {id: data.id},
        ...
        function add() {
            layer_show('历史记录添加', '/admin/analysis/jilu_add?cid=<?php echo e($cid); ?>');
        }
    </script>
<?php $__env->stopSection(); ?>
